...
- ✅ Railway account (you have this linked to GitHub)
- ✅ `fmr_data.json` file (generated by `explore_fmr.py`)
- ✅ All code committed to GitHub (already done)
